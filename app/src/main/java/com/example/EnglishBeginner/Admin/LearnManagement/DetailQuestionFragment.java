...
public class DetailQuestionFragment extends Fragment implements View.OnClickListener {
    ...
    public void openDialogEditQuestion(int center, Question question) {
        ...
        btnYes.setOnClickListener(v -> {
            ...
            question1.setId(question != null ? question.getId() : 0);
            ...
            for (Topic topic : questionInterface.daoTopic.getTopicList()) {
                if (question != null && question.getNameTopic().equalsIgnoreCase(topic.getNameTopic())) {
                    question1.setIdTopic(topic.getId());
                    break;
                }
            }
            for (TypeQuestion typeQuestion : questionInterface.daoTypeQuestion.getTypeQuestionList()) {
                if (question != null && question.getNameTypeQuestion().equalsIgnoreCase(typeQuestion.getTypeQuestionName())) {
                    question1.setIdTypeQuestion(typeQuestion.getId());
                    break;
                }
            }
